...
const Tasks = () => {
  ...
  return (
    <div className="max-w-[1100px] mx-auto w-full pb-20 mt-4 px-4 sm:px-6 font-sans">
      {/* PAGE HEADER */}
      <div className="mb-10 border-b border-emerald-100 pb-6 flex justify-between items-end">
        <div>
        ...
        <div className="hidden sm:flex flex-col items-end">
          <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-600/70 mb-1">
            Total Active
          </span>
